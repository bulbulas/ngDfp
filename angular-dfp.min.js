...
function(a){this.renderCallback=a};b[arguments[2]]=a;return this};this.defineSizeMapping=function(a){c[a]||(c[a]=[]);this.addSize=function(d,e){c[a].push([d,e]);return this};return this};this.setEnabled=function(a){l=a};this.setPageTargeting=function(a,d){m[a]=d};this.collapseEmptyDivs=function(){n=!0};var h=!0,k=this;this.$get=["$q","$window","$interval",function(a,d,e){var c=a.defer();k._createTag(function(){k._initialize();null!==k._refreshInterval()&&e(function(){googletag.cmd.push(function(){d.googletag.pubads().refresh()})},
