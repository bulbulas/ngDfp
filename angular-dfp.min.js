...
angular.module("ngDfp",[]).constant("ngDfpUrl","//www.googletagservices.com/tag/js/gpt.js").provider("DoubleClick",["ngDfpUrl",function(g){var b={},f={},c={},p=null,l=!0,m={},n=!1,h=!1;this._createTag=function(a){if(l){var d=document.createElement("script"),e="https:"===document.location.protocol,c=document.getElementsByTagName("script")[0];d.async=!0;d.type="text/javascript";d.src=(e?"https:":"http:")+g;c.parentNode.insertBefore(d,c);d.onreadystatechange=function(){"complete"==this.readyState&&a()};
d.onload=a}};this._initialize=function(){var a=this;googletag.cmd.push(function(){angular.forEach(b,function(a,e){f[e]=googletag.defineSlot.apply(null,a).addService(googletag.pubads());c[e]&&f[e].defineSizeMapping(c[e]);var b=a.getSlotTargeting();b&&angular.forEach(b,function(a,d){f[e].setTargeting(a.id,a.value)})});angular.forEach(m,function(a,e){googletag.pubads().setTargeting(e,a)});n&&googletag.pubads().collapseEmptyDivs();googletag.pubads().enableSingleRequest();h?googletag.pubads().enableAsyncRendering():
googletag.pubads().enableSyncRendering();googletag.enableServices();googletag.pubads().addEventListener("slotRenderEnded",a._slotRenderEnded)})};this._slotRenderEnded=function(a){a=b[a.slot.getSlotId().getDomId()].renderCallback;"function"===typeof a&&a()};this._refreshInterval=function(){return p};this.setRefreshInterval=function(a){p=a;return this};this.defineSlot=function(){var a=arguments;a.getSize=function(){return this[1]};a.getSlotTargeting=function(){return this[3]?this[3]:!1};a.setRenderCallback=
function(a){this.renderCallback=a};b[arguments[2]]=a;return this};this.defineSizeMapping=function(a){c[a]||(c[a]=[]);this.addSize=function(d,e){c[a].push([d,e]);return this};return this};this.setEnabled=function(a){l=a};this.setPageTargeting=function(a,d){m[a]=d};this.collapseEmptyDivs=function(){n=!0};this.enableAsyncRendering=function(){h=!0};var k=this;this.$get=["$q","$window","$interval",function(a,d,e){var c=a.defer();k._createTag(function(){k._initialize();null!==k._refreshInterval()&&e(function(){googletag.cmd.push(function(){d.googletag.pubads().refresh()})},
